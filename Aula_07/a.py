...
def verificar_delimitadores(expressao: str) -> bool:
    ...
    for caractere in expressao:
        if caractere in delimitadores_abertura:
            pilha.push(caractere)
        elif caractere in delimitadores_fechamento:
            if pilha.esta_vazia():
                return False
            if pilha.pop() != pares_delimitadores[caractere]:
                return False
